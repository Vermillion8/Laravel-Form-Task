  ...
  <div class="flex items-center justify-center h-screen">
    <form method="post" action="/form" enctype="multipart/form-data">
      ...
      <div class="text-center">
        <h1 class="text-3xl font-semibold text-gray-700 dark:text-gray-200">Register</h1>
      ...
      <div class="relative z-0 w-full mb-6 group">
        ...
        @error('floating_repeat_password')
        <div class="alert alert-danger fs-6 text"> {{ $message }} </div>
        @enderror
      ...
      <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="floating_age" id="floating_age" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" ">
        @error('floating_age')
        <div class="alert alert-danger fs-6 text"> {{ $message }} </div>
        @enderror
